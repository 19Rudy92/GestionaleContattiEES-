...
public class ConfigurazioneSicurezza extends WebSecurityConfigurerAdapter {
	...
	@Autowired
	private ServizioSicurezza servizioSicurezza;
	@Autowired
	private PuntoIngressoAutenticazioneNonAutorizzato unauthorizedHandler;
	...
	public void configure(AuthenticationManagerBuilder authenticationManagerBuilder) throws Exception {
		authenticationManagerBuilder.userDetailsService(servizioSicurezza).passwordEncoder(passwordEncoder());
	}
